...
class NutritionConsultationPaymentSuccess extends StatelessWidget {
  final String pageSource;
  final String paymentEvent;
  final double totalPayment;
  final String currency;
  final dynamic customData;
  const NutritionConsultationPaymentSuccess(
      {Key? key,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 286.w,
                      child: Text(
                        "Your payment for the nutrition package was processed successfully",
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) => NutritionistSlots(
                                  consultType: "ADD-ON",
                                  coachId: customData["coachId"],
                                  bookType: "PAID"),
                            ),
                          );
                        },
                        child: mainButton("Schedule your first session"),
                      ),
                    ),
                    SizedBox(
                      height: 20.h,
