...
class ConfirmDoctorSessions extends StatelessWidget {
  final PageController pageController;
  const ConfirmDoctorSessions({Key? key, required this.pageController})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    PostAssessmentController postAssessmentController = Get.find();
    ConsultingPackagesModelConsultingPackagesDoctorPackages? selectedPackage =
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  width: 265.w,
                  child: Text(
                    "Confirm your doctor consultation session bookings",
                ...
                InkWell(
                  onTap: () async {
                    ...
                    EventsService().sendEvent("Doctor_Payment_Selected", {
