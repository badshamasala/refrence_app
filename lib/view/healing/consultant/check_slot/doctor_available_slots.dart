...
import 'widgets/no_slots_available.dart';

class DoctorAvailableSlots extends StatelessWidget {
  const DoctorAvailableSlots({Key? key}) : super(key: key);
        ...
        GetBuilder<DoctorController>(
          ...
          builder: (slotController) {
            if (slotController.isSlotDetailsLoading.value == true) {
              ...
              return const NoSlotsAvailable(profession: "Doctor");
            } else {
              return Column(
                children: [
                  Text(
