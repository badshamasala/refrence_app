...
class PersonalTrainerAvailableSlots extends StatelessWidget {
  const PersonalTrainerAvailableSlots({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        GetBuilder<PersonalTrainerController>(
            id: "SlotCalender",
