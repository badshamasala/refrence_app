...
import 'package:aayu/view/consulting/psychologist/initial_assessment/widgets/assessment_question.dart';
import 'package:aayu/view/consulting/psychologist/initial_assessment/widgets/subjective_options.dart';
...
class PsychologyInitialAssessment extends StatelessWidget {
  const PsychologyInitialAssessment({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    PsychologyInitialAssessmentController assessmentController =
        Get.put(PsychologyInitialAssessmentController());
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            GetBuilder<PsychologyInitialAssessmentController>(
        ...
        bottomNavigationBar: GetBuilder<PsychologyInitialAssessmentController>(
          ...
          return AssessmentActions(assessmentController: buttonController);
        }),
      ),
    );
  }
