...
class NutritionistAvailableSlots extends StatelessWidget {
  const NutritionistAvailableSlots({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        GetBuilder<NutritionListController>(
            id: "SlotCalender",
        ...
        GetBuilder<NutritionListController>(
          ...
          builder: (slotController) {
            if (slotController.isSlotDetailsLoading.value == true) {
              ...
              return const NoSlotsAvailable(profession: "Nutritionist");
            } else {
              return Column(
                children: [
                  Text(
                        ...
                        return InkWell(
                          onTap: () {
                            ...
                            slotController
                                ...
                                !slotController
                                    .selectedDateSlots[slotIndex].selected!;
                            slotController.update(["AvailableSlots", "AvailableSlotAction"]);
                          },
                          child: Container(
                            height: 40.h,
                            width: 98.w,
