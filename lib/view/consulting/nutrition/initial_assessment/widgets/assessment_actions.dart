...
class AssessmentActions extends StatelessWidget {
  ...
  final NutritionInitialAssessmentController assessmentController;
  const AssessmentActions({Key? key, required this.assessmentController, required this.pageSource})
      : super(key: key);
                ...
                child: Align(
                  ...
                  child: InkWell(
                    onTap: () async {
                      ...
                      await assessmentController.getNextQuestion(pageSource);
