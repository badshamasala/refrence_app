...
//   capRightEdge: false,
//   background: Color.fromRGBO(252, 175, 175, 0.2),
// );
...
enum NewCupertinoDatePickerMode {
...
///  * [CupertinoPicker], the class that implements a content agnostic spinner UI.
class NewCupertinoDatePicker extends StatefulWidget {
  ...
  NewCupertinoDatePicker({
    ...
    this.mode = NewCupertinoDatePickerMode.dateAndTime,
    ...
    assert(
      mode != NewCupertinoDatePickerMode.dateAndTime ||
          minimumDate == null ||
  ...
  final NewCupertinoDatePickerMode mode;
  ...
  State<StatefulWidget> createState() {
    ...
    // state.
    switch (mode) {
      case NewCupertinoDatePickerMode.time:
      case NewCupertinoDatePickerMode.dateAndTime:
        return _NewCupertinoDatePickerDateTimeState(overlayColor, textColor);
      case NewCupertinoDatePickerMode.date:
        return _NewCupertinoDatePickerDateState(
            dateOrder: dateOrder,
...
class _NewCupertinoDatePickerDateTimeState
    extends State<NewCupertinoDatePicker> {
  final Color overlayColor;
  final Color textColor;
  ...
  _NewCupertinoDatePickerDateTimeState(this.overlayColor, this.textColor);
//    Widget _leftSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(
//   capRightEdge: false,
//   background: overlayColor,
// );
//  Widget _centerSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(
//     background: Color.fromRGBO(252, 175, 175, 0.2),
//     capLeftEdge: false,
//     capRightEdge: false);
// Widget _rightSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(
//   capLeftEdge: false,
//   background: Color.fromRGBO(252, 175, 175, 0.2),
// );
  ...
  @override
  void didUpdateWidget(NewCupertinoDatePicker oldWidget) {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] =
          NewCupertinoDatePicker._getColumnWidth(
      ...
      child: CupertinoPicker.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return itemPositioningBuilder(
            context,
            Text(dateText,
                style: _themeTextStyle(context).copyWith(color: textColor)),
          );
        },
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.mode == NewCupertinoDatePickerMode.dateAndTime) {
      if (localizations.datePickerDateTimeOrder ==
              DatePickerDateTimeOrder.time_dayPeriod_date ||
          localizations.datePickerDateTimeOrder ==
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      ...
      Widget selectionOverlay = CupertinoPickerDefaultSelectionOverlay(
          background: overlayColor, capStartEdge: false, capEndEdge: false);
      if (i == 0) {
...
class _NewCupertinoDatePickerDateState extends State<NewCupertinoDatePicker> {
  _NewCupertinoDatePickerDateState({
...
class _CupertinoTimerPickerState extends State<CupertinoTimerPicker> {
  ...
  @override
  Widget build(BuildContext context) {
    final Widget _leftSelectionOverlay = CupertinoPickerDefaultSelectionOverlay(
      capEndEdge: false,
      background: widget.overlayColor,
    );
    final Widget _centerSelectionOverlay =
        CupertinoPickerDefaultSelectionOverlay(
            background: widget.overlayColor,
            capStartEdge: false,
            capEndEdge: false);
    final Widget _rightSelectionOverlay =
        CupertinoPickerDefaultSelectionOverlay(
      capStartEdge: false,
      background: widget.overlayColor,
    );
