...
class NutritionSessionController extends GetxController
  ...
  Future<void> getUpcomingSessions() async {
    try {
      ...
      CoachUpcomingSessionsModel? response = await CoachService()
          .upcomingSessions(globalUserIdDetails!.userId!, "Nutritionist");
      if (response != null &&
  ...
  Future<void> getPastSessions() async {
    try {
      ...
      CoachPastSessionsModel? response = await CoachService()
          .pastSessions(globalUserIdDetails!.userId!, "Nutritionist");
  ...
  Future<void> getSessionSummary() async {
    try {
      ...
      CoachSessionSummaryModel? response = await CoachService()
          .getSessionsSummary(globalUserIdDetails!.userId!, "Nutritionist");
  ...
  joinCallViaAgora(
    ...
    if (joinCallDetails.agoraDetails!.token != null) {
      ...
      EventsService().sendEvent("Nutritionist_Session_Call_Join", {
      ...
      EventsService()
          .sendClickNextEvent("NutritionistSessions", "Session", "VideoCallAgora");
  ...
  getPendingReviews() async {
    try {
      ...
      CoachPendingReviewsModel? response = await CoachService()
          .getPendingReviews(globalUserIdDetails!.userId!, "Nutritionist");
